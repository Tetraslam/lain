...
#
# It always grabs the latest release — a binary rebuilt from the newest commit
# on main that passed CI — so installs stay as fresh as a git pull.
#
# Env overrides:
...
#   LAIN_VERSION_TAG     a specific release tag to install (default: latest)
#
set -euo pipefail
